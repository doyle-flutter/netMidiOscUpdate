...
//      'http://13.124.102.207:3000',
      'http://192.168.0.2:8808',
      '/',
    )
      ..init()
      ..subscribe('receive_message', (jsonData) async{
        await Future.microtask(() async{
          ...
          if(data['message']==null){
            ...
            var midi = data['message'].runtimeType != int ? int.parse(data['message']) : data['message'];
            fMid.playMidiNote(midi: midi);
            fMid.unmute();
          }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
          appBar: AppBar(title: Text("Play ${messages.isEmpty ? "": messages[messages.length-1]['message']}"),),
